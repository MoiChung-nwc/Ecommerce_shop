            ...
            <div class="col-md-7">
                <div class="bg-light right">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <small class="pt-2 ps-1">({{ ($product->product_ratings_count > 1) ? $product->product_ratings_count. ' Reviews' : $product->product_ratings_count. ' Reviews'}})</small>
                    </div>
                            ...
                            <div class="col-md-12 mt-5">
                                <div class="overall-rating mb-3">
                                    <div class="d-flex">
                                        ...
                                        <div class="pt-2 ps-2">({{ ($product->product_ratings_count > 1) ? $product->product_ratings_count. ' Reviews' : $product->product_ratings_count. ' Reviews'}})</div>
                                    </div>
                    ...
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            ...
                            <a href="{{ route("front.product",$relProduct->slug) }}" class="product-img">
                                ...
                                @else
                                    <img src="{{asset('admin-assest/img/default-150x150.png')}}" class="img-thumbnail"  />
                                @endif
                            </a>
