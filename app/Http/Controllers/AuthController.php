...
class AuthController extends Controller
{
    ...
    public function authenticate(Request $request){
        ...
        if($validator->passes()){
            ...
            if(Auth::attempt(['email'=> $request->email,'password'=> $request->password],$request->get('remeber'))){
    ...
    public function processForgotPassword(Request $request) {
        ...
        return redirect()->route('front.forgotPassword')->with('success','Please check tour inbox to reset password');
    }
